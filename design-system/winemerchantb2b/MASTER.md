...
**Project:** WineMerchantB2B
**Generated:** 2026-02-09 09:27:17
...
|------|-----|--------------|
| Primary | `#722F37` | `--color-primary` |
| Secondary | `#9A1B36` | `--color-secondary` |
| CTA/Accent | `#4A0413` | `--color-cta` |
| Background | `#F8FAFC` | `--color-background` |
| Text | `#020617` | `--color-text` |

**Color Notes:** Bordeaux Red theme for wine merchant elegance.
